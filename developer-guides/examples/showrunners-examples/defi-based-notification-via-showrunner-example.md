...
HELLO!\
\
If you are new to PUSH protocol and don't have a proper idea of how to create a DEFI-based channel for notifications on top of [showrunners](https://docs.epns.io/developers/developer-tooling/showrunners-framework). This guide is for you ;)\
\
...
* Contract Address for <mark style="color:orange;">AAVE Lending Pool</mark> on the ethereum main-network : _`0x7d2768dE32b0b80b7a3454c06BdAc94A69DDc7A9`_
* ABI for <mark style="color:orange;">AAVE Lending Pool</mark> smart contract:
